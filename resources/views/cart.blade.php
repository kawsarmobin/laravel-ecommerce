                                ...
                                @foreach(Cart::content() as $pdt)
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-quantity">
                                            ...
                                            <div class="quantity">
                                                <a href="{{ route('cart.decrease', [$pdt->rowId, $pdt->qty]) }}" class="quantity-minus">-</a>
                                                <input title="Qty" class="email input-text qty text" type="text"
                                                       placeholder="1" value="{{ $pdt->qty }}" readonly>
                                                <a href="{{ route('cart.increase', [$pdt->rowId, $pdt->qty]) }}" class="quantity-plus">+</a>
                                            </div>
